...
- quiz.html — Intake + Quiz: the conversational intake (name, email, phone, student ID) followed by a 10-question quiz. Throughline progress motif appears here.
...
How to run
- click on link:  https://skill-advisor-five.vercel.app/index.html
...
- The throughline spans the full journey (4 intake + 10 quiz = 12 steps) and is animated via CSS + small orchestration in JS.
